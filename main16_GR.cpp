...
int main(int argc, char *argv[])
{
	...
	if(argc != 1 and argc !=2 and argc!=3)
	{
		...
		cerr << "liczba powtorzen GR dla każdej instancji sieci, wielkosc sieci N" << endl; 
		return 1;
	}
	...
	std::string path = "./data_topologie_4"; // uwaga, zmieniajac te sciezce pamietaj zmienic "extract erase", linie 271-275
