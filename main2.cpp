...
int greedy_routing(const vector<Node>& nodes_, const vector<vector<pair<bool,double>>>& connectivity_matrix, const int node_start, const int node_target, const double R)
{
	...
	while(true)
	{
		...
		int index_of_neighbour_closest_to_target;
		double minimal_distance = R*1000; // na pewno wiekszy od jakiekolwiek mozliwego dystansu
...
int main(int argc, char *argv[])
{
	...
	cout << "hop length: " << greedy_routing(nodes_, connectivity_matrix, 5, 77, R) << endl;
